...
|----------|------|---------|
| **Exercise 00** | `ex00_DLV_stakeholders.csv` | Каталог заинтересованных сторон (9 основных) |
| **Exercise 00+** | `ex00_DLV_stakeholders_extended.csv` | Расширенный каталог (15 всего, включая дополнительные) |
| **Exercise 01** | `ex01_DLV_onion.md` | Луковичная диаграмма (4 слоя взаимодействия) |
| **Exercise 02** | `ex02_DLV_needs.csv` | Интересы, потребности и проблемы стейкхолдеров |
| **Exercise 03** | `ex03_DLV_glossary.csv` | Глоссарий из 11 ключевых терминов |
...
- Посмотрите **ex00_DLV_stakeholders.csv** для понимания всех пользователей
- Изучите **ex02_DLV_needs.csv** для требований
...
- **ex02_DLV_needs.csv** определяет потребности каждого
- **ex03_DLV_glossary.csv** помогает в терминологии

### Для тестировщика
- **ex00_DLV_stakeholders.csv** определяет сценарии для каждой роли
- **ex02_DLV_needs.csv** показывает критичные требования
...
1. Добавьте их в `ex00_DLV_stakeholders_extended.csv` с ID st01600+
2. Обновите луковичную диаграмму в `ex01_DLV_onion.md`
3. Добавьте анализ в `ex02_DLV_needs.csv`
4. Обновите глоссарий в `ex03_DLV_glossary.csv` если нужны новые термины
